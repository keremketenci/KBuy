...
export default function Add({ categories }: { categories: any[] }) {
            ...
            <div className="w-full max-w-4xl p-6 bg-white rounded-lg shadow-md dark:bg-gray-800">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <Button
                        type="submit"
                        disabled={processing}
                        className="px-4 py-2 mt-4 text-white bg-blue-600 rounded-lg hover:bg-blue-700 disabled:bg-blue-400"
                    >
