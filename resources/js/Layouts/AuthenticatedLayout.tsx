import Dropdown from '@/Components/inertia/ui/Dropdown';
import NavLink from '@/Components/inertia/ui/NavLink';
import ResponsiveNavLink from '@/Components/inertia/ui/ResponsiveNavLink';
                ...
                >
                    ...
                    <div className="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
                        ...
                        <div className="mt-3 space-y-1">
                            <ResponsiveNavLink
                                href={route(`${user.role}.profile.edit`)}
                            >
                                Profile
                            </ResponsiveNavLink>
                            <ResponsiveNavLink
